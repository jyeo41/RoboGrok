...
module top ;
	...
	wire [0:0] tmpOE__motor_1_net;
	wire [0:0] tmpFB_0__motor_1_net;
	wire [0:0] tmpIO_0__motor_1_net;
	wire [0:0] tmpINTERRUPT_0__motor_1_net;
	electrical [0:0] tmpSIOVREF__motor_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		motor_1
		 (.oe(tmpOE__motor_1_net),
		  .y({Net_197}),
		  .fb({tmpFB_0__motor_1_net[0:0]}),
		  .io({tmpIO_0__motor_1_net[0:0]}),
		  .siovref(tmpSIOVREF__motor_1_net),
		  .interrupt({tmpINTERRUPT_0__motor_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motor_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__motor_2_net;
	wire [0:0] tmpFB_0__motor_2_net;
	wire [0:0] tmpIO_0__motor_2_net;
	wire [0:0] tmpINTERRUPT_0__motor_2_net;
	electrical [0:0] tmpSIOVREF__motor_2_net;

	cy_psoc3_pins_v1_10
		#(.id("1be726c4-786b-4ef6-a45d-1bad3afd255a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motor_2
		 (.oe(tmpOE__motor_2_net),
		  .y({Net_198}),
		  .fb({tmpFB_0__motor_2_net[0:0]}),
		  .io({tmpIO_0__motor_2_net[0:0]}),
		  .siovref(tmpSIOVREF__motor_2_net),
		  .interrupt({tmpINTERRUPT_0__motor_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motor_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
